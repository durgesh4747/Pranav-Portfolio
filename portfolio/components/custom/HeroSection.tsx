...
export default function HeroSection() {
  return (
    <section
      id="home"
      className="relative min-h-screen w-full flex flex-col items-center justify-center bg-[#0B1220] text-slate-100 overflow-hidden mt-5"
    >
      {/* Layered background effects */}
      <div className="absolute inset-0 bg-linear-to-br from-[#0B1220] via-[#0d1528] to-[#0B1220]" />
      ...
      {/* Floating orbs - all contained within */}
      <div className="absolute top-1/4 left-1/4 w-48 h-48 md:w-64 md:h-64 bg-[#F5C16C]/10 rounded-full blur-[80px] animate-pulse" />
      <div className="absolute bottom-1/3 right-1/4 w-56 h-56 md:w-80 md:h-80 bg-purple-500/8 rounded-full blur-[100px] animate-pulse" style={{ animationDelay: '1s' }} />
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 justify-center w-full max-w-4xl mx-auto">
        ...
        <div className="mb-8 flex items-center gap-3">
          <div className="h-[1px] w-8 md:w-12 bg-linear-to-r from-transparent to-[#F5C16C]/50" />
          <p className="text-[10px] md:text-xs uppercase tracking-[0.4em] text-slate-400/80 font-light">
            Video Editor <br/> Visual Storyteller
          </p>
          <div className="h-[1px] w-8 md:w-12 bg-linear-to-l from-transparent to-[#F5C16C]/50" />
        </div>

        {/* Name / Identity with corner accents */}
        ...
        {/* Description with linear headline */}
        ...
        <p className="max-w-xl text-sm md:text-base text-slate-400 leading-relaxed font-light mb-10">
          Crafting compelling visual narratives, dynamic short-form content, and brand stories that captivate and resonate.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4">
          ...
          >
            <span className="relative z-10 tracking-wide">Explore Portfolio</span>
            <svg 
      ...
      {/* Bottom fade */}
      <div className="absolute bottom-0 left-0 right-0 h-32 bg-linear-to-t from-[#0B1220] to-transparent pointer-events-none" />
    </section>
  );
}
